    ...
    private void initComponents() {
        ...
        sessionsTablePanelLayout.setHorizontalGroup(
            ...
            .add(sessionsTablePanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(sessionsScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1215, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        todaySessionsPanelLayout.setHorizontalGroup(
            ...
            .add(todaySessionsPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(todaySessionsScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1215, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        reportsPaneLayout.setHorizontalGroup(
            ...
            .add(0, 1272, Short.MAX_VALUE)
            .add(reportsPaneLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                .add(reportsScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1272, Short.MAX_VALUE))
        );
