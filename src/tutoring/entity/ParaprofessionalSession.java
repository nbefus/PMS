...
public class ParaprofessionalSession
{
    ...
    public enum ParaSessTable
    {
        ...
        /**
         * Paraprofessional ID of the creator of the Paraprofessional Session of
         * the ParaprofessionalSession table
         */
        PARAPROFESSIONALCREATORID("Creator ID", "paraprofessionalCreatorID", true, getTableAlias() + ".paraprofessionalCreatorID", true),
        /**
         * Time and date entered of the session in the ParaprofessionalSession
         * table
         */
        TIMEANDDATEENTERED("Date Entered", "timeAndDateEntered", true, getTableAlias() + ".timeAndDateEntered", false),
        /**
         * Session start date and time of the session in the
         * ParaprofessionalSession table
         */
        SESSIONSTART("Session Start", "sessionStart", true, getTableAlias() + ".sessionStart", false),
        /**
         * Session end date and time of the session in the
         * ParaprofessionalSession table
         */
        ...
        /**
         * First name of the Paraprofessional table for the creator of the
         * Paraprofessional Session
         */
        CREATORFNAME("Creator First", "fName", false, getCreatorAlias() + ".fName", false),
        /**
         * Last name of the Paraprofessional table for the creator of the
         * Paraprofessional Session
         */
        CREATORLNAME("Creator Last", "lName", false, getCreatorAlias() + ".lName", false),
        /**
         * Hire date of the Paraprofessional table for the creator of the
         * Paraprofessional Session
         */
        CREATORHIREDATE("Creator Hire Date", "hireDate", false, getCreatorAlias() + ".hireDate", false),
        /**
         * Termination date of the Paraprofessional table for the creator of the
         * Paraprofessional Session
         */
        CREATORTERMINATIONDATE("Creator Termination Date", "terminationDate", false, getCreatorAlias() + ".terminationDate", false),
        /**
         * Clocked in boolean of the Paraprofessional table for the creator of
         * the Paraprofessional Session
         */
        CREATORISCLOCKEDIN("Creator Is In?", "isClockedIn", false, getCreatorAlias() + ".isClockedIn", false),
        /**
         * Role ID of the Paraprofessional table for the creator of the
         * Paraprofessional Session
         */
        CREATORROLEID("Creator Role ID", "roleID", false, getCreatorAlias() + ".roleID", true),
        /**
         * Type of the role of the Role table for the creator of the
         * Paraprofessional Session
         */
    ...
    /**
     * Create a select statement for the paraprofessional session table and
